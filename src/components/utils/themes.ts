...
export const THEMES: Theme[] = [
  {
    id: 'gx-neon',
    name: 'Default',
    description: 'Classic NetGlide purple neon aesthetic',
    colors: {
      background: '#0a0a0f',
  ...
  },
  {
    id: 'nordic-frost',
    name: 'Nordic Frost',
    description: 'Crisp arctic blues and frosted whites',
    colors: {
      background: '#05101a',
      backgroundGradientFrom: 'rgb(15, 23, 42)', // slate-900
      backgroundGradientTo: 'rgb(7, 89, 133)', // sky-900
      primary: 'rgb(125, 211, 252)', // sky-300
      primaryDark: 'rgb(56, 189, 248)', // sky-400
      secondary: 'rgb(224, 242, 254)', // sky-50
      ...
      cardBorder: 'rgba(125, 211, 252, 0.2)',
    },
  ...
  },
  {
    id: 'forest-emerald',
    name: 'Forest Emerald',
    description: 'Deep mystical forest greens',
    colors: {
      background: '#051a0f',
      backgroundGradientFrom: 'rgb(6, 78, 59)', // emerald-950
      backgroundGradientTo: 'rgb(2, 44, 34)', // teal-950
      primary: 'rgb(52, 211, 153)', // emerald-400
      primaryDark: 'rgb(16, 185, 129)', // emerald-500
      secondary: 'rgb(132, 204, 22)', // lime-500
      accent: 'rgb(5, 150, 105)', // emerald-600
      text: '#ffffff',
      textSecondary: 'rgb(167, 243, 208)', // emerald-200
  ...
  },
  {
    id: 'golden-ember',
    name: 'Golden Ember',
    description: 'Royal gold with elegant dark charcoal',
    colors: {
      background: '#0f0c05',
      backgroundGradientFrom: 'rgb(69, 26, 3)', // orange-950
      backgroundGradientTo: 'rgb(23, 23, 23)', // neutral-900
      primary: 'rgb(251, 191, 36)', // amber-400
      primaryDark: 'rgb(245, 158, 11)', // amber-500
